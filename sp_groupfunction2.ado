...
#delimit cr;
//Housekeeping
local meth coverage targeting dependency poverty mean beneficiaries benefits
...
local allmyvar `coverage' `dependency' `dependency_d' `poverty' `povertyline' `mean' `targeting' `beneficiaries' `benefits'
...
foreach y in coverage dependency dependency_d poverty povertyline mean targeting beneficiaries benefits{
	if ("``y''"!=""){
...
sum(`targeting2' `benefits2' `beneficiaries2') rawsum(_population) by(`by') norestore
